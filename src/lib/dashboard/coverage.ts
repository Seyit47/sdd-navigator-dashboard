...
export const STATUS_PRESENTATION: Record<CoverageStatus, StatusPresentation> = {
  covered: { assessment: "Fully covered", icon: "✓", color: "var(--good)", tint: "var(--good-tint)" },
  partial: { assessment: "Needs tests", icon: "◐", color: "var(--warning)", tint: "var(--warning-tint)" },
  missing: { assessment: "Not implemented", icon: "✕", color: "var(--critical)", tint: "var(--critical-tint)" },
};
